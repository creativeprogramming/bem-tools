var Q = require('qq'),
    ...
    Tech = exports.Tech = INHERIT({
        ...
        getCreateDependenciesTechs: function() {
            return [];
        },

        getCreateDependenciesPaths: function(prefix) {
            var _this = this,
                paths = [];
            (this.getCreateDependenciesTechs() || []).forEach(function(tech) {
                if (typeof tech == 'string') tech = _this.getContext().getTech(tech);
                paths = paths.concat(tech.getPaths(prefix));
            });
            return paths;
        },
